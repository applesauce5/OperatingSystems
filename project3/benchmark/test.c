...
int main() {
    ...
    //printf("FIRST MALLOC ------- 1\n");
    //printf("--------------------------------------\n");
    void *a = m_alloc(100*4);
    
    
    int old_a = (int)a;
    //printf("SECOND MALLOC ------- 2\n");
    //printf("--------------------------------------\n");
    void *b = m_alloc(100*4);
    //printf("THIRD MALLOC ------- 3\n");
    //printf("--------------------------------------\n");
    void *c = m_alloc(100*4);
    //printf("THIRD MALLOC IS DONE------- 3\n");
    //printf("--------------------------------------\n");
    ...
    for (i = 0; i < SIZE; i++) {
		...
		//printf("Calling translate MATRIX A...............\n");
            PutVal((void *)address_a, &x, sizeof(int));
		//printf("Calling translate MATRIX B...............\n");
    ...
    a = m_alloc(100*4);
    printf("Addresses of the allocations: %d.\n",(int)a);
    if ((int)a == old_a)
